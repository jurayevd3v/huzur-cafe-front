...
export default function AdminMenu() {
    ...
    return (
        <div className="overflow-y-scroll w-full h-screen pb-20">
            <div className="w-full p-5 bg-[white] border-b border-[#026634]">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-5">
                        <h1 className="text-2xl">Menu</h1>
                        <button
                            onClick={() => setCreateModal(true)}
                            className="bg-[#026634] text-lg px-5 py-2 rounded-md text-white border-2 border-[#026634] duration-500 hover:bg-transparent hover:text-[#026634]"
                        >
                            Yaratish
                        </button>
                    </div>
                        ...
                        <table className="min-w-full bg-white border-collapse">
                            ...
                            <tbody>
                                {displayedData.map((item) => (
                                    <tr key={item.id} className="border-b border-[#026634]">
