...
export default function AdminEmployee() {
  ...
  return (
    <div className="overflow-y-scroll w-full h-screen pb-20">
      <div className="w-full p-5 bg-white border-b border-[#026634] flex justify-between items-center">
        <div className="flex items-center gap-5">
          <h1 className="text-2xl">Xodimlar</h1>
          <button
            onClick={() => setCreateModal(true)}
            className="bg-[#026634] text px-5 py-2 rounded-md text-white border-2 border-[#026634] hover:bg-transparent hover:text-[#026634] transition"
          >
            Yaratish
          </button>
        </div>
        ...
        <>
          <div className="overflow-x-auto mt-5 p-6">
            <table className="min-w-full bg-white border-collapse">
              <thead className="bg-[#026634] text-white">
              ...
              <tbody>
                {displayedEmployees.map((employee) => (
                  <tr key={employee.id} className="border-b border-[#026634]">
                    ...
                    <td className="py-2 px-4">
                      <button
                        ...
                        className="bg-[#026634] text-white px-3 py-1 rounded hover:bg-[#259c61]"
                      >
                        Izohlarni ko‘rish
                      </button>
                    </td>
