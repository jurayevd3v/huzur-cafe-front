...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#026634]">
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-lg text-center">
        ...
        <div className="space-y-4">
          <Input
            ...
            type="text"
            required
            className="border-[#026634]"  // Black border color
          />
          <Input
            label="Password"
            value={password}
          ...
          <Button
            ...
            onClick={Login}
            className="bg-[#026634] text-white hover:bg-gray-800"
          >
            Login
          </Button>
        </div>
