...
export default function AdminCategory() {
    ...
    return (
        <div className="overflow-y-scroll w-full h-screen pb-20">
            <div className="w-full p-5 bg-[white] border-[#026634] border-b">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-5">
                        <h1 className="text-2xl">Turkum</h1>
                        <button onClick={() => setCreateModal(true)} className="bg-[#026634] text-lg px-5 py-2 rounded-md border-2 text-white border-[#026634] duration-500 hover:bg-transparent hover:text-[#026634]">
                            Yaratish
                        </button>
                    </div>
                </div>
                    ...
                    <table className="min-w-full table-auto">
                        ...
                        <tbody>
                            {displayedData.map((row) => (
                                <tr key={row.id} className="border-b border-[#026634]">
