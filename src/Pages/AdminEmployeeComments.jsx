...
export default function AdminEmployeeComments() {
  ...
  return (
    <div className="px-6 w-full">
      <div className="w-full p-5 bg-white border-b border-[#026634] flex justify-between items-center mb-5">
        <div className="flex items-center gap-5">
          <h1 className="text-2xl">{full_name}</h1>
          <button
            onClick={() => navigate(-1)}
            className="bg-[#026634] p-2 px-5 rounded-md text-white border-2 border-[#026634] hover:bg-transparent hover:text-[#026634] transition"
          >
            Orqaga qaytish
          </button>
        </div>
        ...
        >
          <select
            ...
            className="border border-[#026634] rounded px-4 py-2.5 text-[#026634] w-full"
          >
          ...
          {filterType === "year" && (
            <select
              value={filterValue}
              onChange={(e) => setFilterValue(e.target.value)}
              className="border border-[#026634] rounded px-4 py-2.5"
              required
            >
          ...
          <button
            type="submit"
            className="bg-[#026634] text-white px-4 py-2 rounded hover:bg-[#259c61]"
          >
            Qidirish
          </button>
        </form>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-white shadow border border-[#026634] rounded p-4">
          <p className="text-[#026634]">Jami izohlar 💬</p>
          <p className="text-xl font-bold">{stats.totalComments}</p>
        </div>
        <div className="bg-white shadow border border-[#026634] rounded p-4">
          <p className="text-[#026634]">Reytinglar yig'indisi ⭐</p>
          <p className="text-xl font-bold">{stats.totalRating}</p>
        </div>
        <div className="bg-white shadow border border-[#026634] rounded p-4">
          <p className="text-[#026634]">O'rtacha reyting ⭐</p>
            ...
            <button
              ...
              className={`px-4 py-2 rounded ${
                currentPage === 1
                  ...
                  : "bg-[#026634] text-white hover:bg-[#259c61]"
              }`}
            >
              &lt;
            </button>
