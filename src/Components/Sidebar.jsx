...
const Sidebar = () => {
  ...
  return (
    <div className="relative flex h-screen border-r-[2px] border-[#026634] w-full max-w-[20rem] flex-col bg-white bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5">
